...
public class BodyPartFragment extends Fragment {
    ...
    private static final String EXTRA_IMAGEIDS = "extra_imageids";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(EXTRA_IMAGEIDS);
            mListIndex = savedInstanceState.getInt(EXTRA_INDEX);
        }
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        outState.putIntegerArrayList(EXTRA_IMAGEIDS, (ArrayList<Integer>) mImageIds);
        outState.putInt(EXTRA_INDEX, mListIndex);
    }
}
